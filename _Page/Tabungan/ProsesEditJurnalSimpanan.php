        ...
        if(empty($_POST['id_jurnal'])){
            ...
            if(empty($_POST['id_perkiraan'])){
                ...
                if(empty($_POST['d_k'])){
                    ...
                    if(empty($_POST['nominal_jurnal_simpanan_edit'])){
                        echo '<span class="text-danger">Nilai Saldo Jurnal Tidak Boleh Kosong!</span>';
                    }else{
                        $id_jurnal=$_POST['id_jurnal'];
                        $id_perkiraan=$_POST['id_perkiraan'];
                        $d_k=$_POST['d_k'];
                        $nominal_jurnal_simpanan_edit=$_POST['nominal_jurnal_simpanan_edit'];
                        $nominal_jurnal_simpanan_edit= str_replace(",", "", $nominal_jurnal_simpanan_edit);
                        if(!preg_match("/^[0-9]*$/", $nominal_jurnal_simpanan_edit)){
                            ...
                            $nominal_jurnal_simpanan_edit=validateAndSanitizeInput($nominal_jurnal_simpanan_edit);
                            //Buka Akun Perkiraan
                            ...
                            $UpdateJurnal = mysqli_query($Conn,"UPDATE jurnal SET 
                                ...
                                nama_perkiraan='$nama',
                                d_k='$d_k',
                                nilai='$nominal_jurnal_simpanan_edit'
