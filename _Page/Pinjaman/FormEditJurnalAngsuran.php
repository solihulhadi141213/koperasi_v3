...
?>
    ...
    <div class="row mb-3">
        <div class="col col-md-4">
            <label for="nominal_angsuran_edit">Nominal (Rp)</label>
        </div>
        <div class="col col-md-8">
            <input type="text" required class="form-control format_uang" name="nominal_angsuran_edit" id="nominal_angsuran_edit" value="<?php echo $nilai; ?>">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col col-md-4">
    ...
    <script>
        $('#nominal_angsuran_edit').keypress(function(event) {
