                                ...
                                <table class="table table-hover table-bordered align-items-center mb-0">
                                    <thead class="">
                                        <tr>
                                            ...
                                            <th class="text-center"><b>Tanggal Keluar</b></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            $no=1;
                                            $query = mysqli_query($Conn, "SELECT*FROM anggota WHERE tanggal_keluar like '%$Tanggal%' AND status='Keluar'");
                                            while ($data = mysqli_fetch_array($query)) {
                                                ...
                                                echo '  <td align="left">'.$tanggal_keluar.'</td>';
                                                echo '</tr>';
                                                $no++;
                                            }
                                        ?>
