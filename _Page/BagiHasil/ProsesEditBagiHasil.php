                            ...
                            if(empty($_POST['status'])){
                                ...
                                if(!preg_match("/^[0-9]*$/", $alokasi_nyata)){
                                    ...
                                    if($JumlahKarakterNamaSessi>25){
                                        ...
                                        $sesi_shu_lama=GetDetailData($Conn,'shu_session','id_shu_session',$id_shu_session,'sesi_shu');
                                        if($sesi_shu_lama==$sesi_shu){
                                            $ValidasiDuplikat=0;
                                        }else{
                                        ...
                                        if(!empty($ValidasiDuplikat)){
                                            ...
                                            if($JumlahAnggotaProses==$JumlahAnggota){
                                                $UpdateSessiShu = mysqli_query($Conn,"UPDATE shu_session SET 
                                                    sesi_shu='$sesi_shu',
                                                ...
                                                if($UpdateSessiShu){
                                                    //Hapus Rincian Lama
                                                    $HapusRincianLama= mysqli_query($Conn, "DELETE FROM shu_rincian WHERE id_shu_session='$id_shu_session'") or die(mysqli_error($Conn));
                                                    if(!$HapusRincianLama){
                                                        echo '<small class="text-danger">Terjadi kesalahan pada saat menghapus rincian lama</small>';
                                                    }else{
                                                        //Update Rincian
                                                        ...
                                                        if($UpdateRincian){
                                                            ...
                                                            $KeteranganLog="Edit Sesi Bagi Hasil Berhasil";
