    ...
    if(empty($SessionIdAkses)){
        ...
        if(empty($_POST['id_anggota'])){
            ...
            if(empty($_POST['periode'])){
                ...
                $id_anggota_list=$_POST['id_anggota'];
                $periode=validateAndSanitizeInput($_POST['periode']);
                //Format Periode Data
                $periode_format=date('d F Y', strtotime($periode));

                foreach ($id_anggota_list as $id_anggota) {
                    echo '<div class="row mb-3"><div class="col-12"></div></div>';
                    ...
                    if (!$Qry->execute()) {
                        ...
                        echo '
                            <div class="row mb-2 border-top border-2">
