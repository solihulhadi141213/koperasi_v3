<?php 
    ...
    $sql = "SELECT COUNT(*) as total FROM transaksi_jual_beli WHERE (id_anggota='$id_anggota') AND (kategori='Penjualan' OR kategori='Retur Penjualan') AND (tanggal BETWEEN '$periode_1 00:00:00' AND '$periode_2 23:59:59')";
    // Eksekusi query
    ...
    if(empty($JumlahData)){
        ...
        $no = 1;
        $row = 2;
        $query = mysqli_query($Conn, "SELECT * FROM transaksi_jual_beli WHERE (id_anggota='$id_anggota') AND (kategori='Penjualan' OR kategori='Retur Penjualan') AND (tanggal BETWEEN '$periode_1 00:00:00' AND '$periode_2 23:59:59') ORDER BY tanggal ASC");
        ...
        $filename = "Transaksi-Penjualan-Anggota.xlsx";
