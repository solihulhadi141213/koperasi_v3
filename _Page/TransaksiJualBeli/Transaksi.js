...
$('#MenampilkanTabelTransaksi').load("_Page/TransaksiJualBeli/TabelTransaksi.php");
$('#batas').change(function(){
    var ProsesBatas = $('#ProsesBatas').serialize();
    $('#MenampilkanTabelTransaksi').html('Loading...');
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/TabelTransaksi.php',
        data 	    :  ProsesBatas,
...
$('#keyword_by').change(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormFilterKeyword.php',
...
$.ajax({
    type 	    : 'POST',
    url 	    : '_Page/TransaksiJualBeli/HitungJumlahRincian2.php',
...
$.ajax({
    type 	    : 'POST',
    url 	    : '_Page/TransaksiJualBeli/TabelRincian.php',
    data 	    :  {id_mitra: GetIdMitra},
    success     : function(data){
...
$('#ClickTambahDariRincianEdit').click(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/HitungJumlahRincian3.php',
...
$('#jumlah_transaksi_edit').keyup(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/HitungKembalianEdit.php',
...
$('#ModalCariAnggota').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/TabelAnggota.php',
...
$('#ModalCariSupplier').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/TabelSupplier.php',
...
$('#ModalPilihAnggota').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/MenampilkanKonfirmasiAnggota.php',
        ...
        success     : function(data){
            ...
            $('#KonfirmasiPilihAnggota').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/PutIdAnggota.php',
                    data        : {id_anggota: id_anggota},
...
$('#ModalPilihSupplier').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/MenampilkanKonfirmasiSupplier.php',
        ...
        success     : function(data){
            ...
            $('#KonfirmasiPilihSupplier').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/PutIdSupplier.php',
                    data        : {id_supplier: id_supplier},
                    enctype     : 'multipart/form-data',
                    success     : function(data){
...
$('#ModalTambahRincian').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/TabelBarangTindakan.php',
...
$('#ModalTambahRincianLainnya').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahRincianLainnya.php',
        ...
        success     : function(data){
            ...
            $('#ProsesTambahRincianLainnya').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesTambahRincianLainnya.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalTambahRincianBarang').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahRincianBarang.php',
        ...
        success     : function(data){
            ...
            $('#rincian_satuan_barang').change(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesCariHargaBarang.php',
                    ...
                    success     : function(data){
                        ...
                        $.ajax({
                            type 	    : 'POST',
                            url 	    : '_Page/TransaksiJualBeli/HitungJumlahRincian.php',
            ...
            $('#ProsesTambahRincianBarang').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesTambahRincianBarang.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalTambahPpn').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahPpn.php',
        success     : function(data){
            ...
            $('#ProsesTambahPpn').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesTambahPpn.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalTambahPpnEdit').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahPpnEdit.php',
        ...
        success     : function(data){
            ...
            $('#GetPpnPersenEdit').keyup(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/HitungPpnRp.php',
            ...
            $('#GetPpnRpEdit').keyup(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/HitungPpnPersen.php',
...
$('#ModalEditRincianBarang').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormEditRincianBarang.php',
        ...
        success     : function(data){
            ...
            $('#ProsesEditRincianBarang').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesEditRincianBarang.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalEditRincianLainnya').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormEditRincianLainnya.php',
        data        : {id_transaksi_rincian: id_transaksi_rincian, GetIdTransaksi: GetIdTransaksi},
        success     : function(data){
            ...
            $('#ProsesEditRincianLainnya').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesEditRincianLainnya.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalDeleteTransaksiRincian').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormDeleteRincian.php',
        data        : {id_transaksi_rincian: id_transaksi_rincian, GetIdTransaksi: GetIdTransaksi},
        success     : function(data){
            ...
            $('#KonfirmasiHapusRincian').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesHapusRincianTindakan.php',
                    data        : {id_transaksi_rincian: id_transaksi_rincian, GetIdTransaksi: GetIdTransaksi},
                    enctype     : 'multipart/form-data',
                    success     : function(data){
...
$('#pembayaran').keyup(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/PertimbangkanStatus.php',
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/HitungKembalian.php',
        data 	    :  {pembayaran: pembayaran2, jumlah_transaksi: jumlah_transaksi2},
        success     : function(data){
            $('#kembalian').val(data);
        }
...
$('#ProsesTambahTransaksi').submit(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/ProsesTambahTransaksi.php',
        data 	    :  data,
        cache       : false,
        processData : false,
        contentType : false,
...
$('#ProsesEditTransaksi').submit(function(){
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/ProsesEditTransaksi.php',
        data 	    :  data,
        cache       : false,
        processData : false,
        contentType : false,
...
$('#ModalDetailTransaksi').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormDetailTransaksi.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
...
$('#ModalDeleteTransaksi').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormDeleteTransaksi.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
            ...
            $('#KonfirmasiHapusTransaksi').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesHapusTransaksi.php',
                    data        : {id_transaksi: id_transaksi},
                    success     : function(data){
...
$('#ModalBatalkanTransaksi').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormBatalkanTransaksi.php',
        success     : function(data){
            ...
            $('#KonfirmasiBatalkanTransaksi').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesBatalkanTransaksi.php',
                    data        : {id_mitra: GetIdMitra2},
                    success     : function(data){
...
$.ajax({
    type 	    : 'POST',
    url 	    : '_Page/TransaksiJualBeli/TabelJurnal.php',
    data        : {id_transaksi: GetIdTransaksi},
    success     : function(data){
...
$.ajax({
    type 	    : 'POST',
    url 	    : '_Page/TransaksiJualBeli/TabelPembayaran.php',
    data        : {id_transaksi: GetIdTransaksi},
    success     : function(data){
...
$('#ModalTambahJurnal').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahJurnal.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
...
$('#ModalHapusSemuaJurnal').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormHapusSemuaJurnal.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
            ...
            $('#KonfirmasiHapusSemuaJurnal').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesHapusSemuaJurnal.php',
                    data        : {id_transaksi: id_transaksi},
                    success     : function(data){
...
$('#ModalEditTransaksi').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormEditTransaksi.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
            ...
            $('#id_mitra_edit').change(function(){
                ...
                if(id_mitra_edit==""){
                    ...
                    $('#Transaksi_edit').load('_Page/TransaksiJualBeli/PilihTransaksiMitra.php');
                }
            });
...
$.ajax({
    type 	    : 'POST',
    url 	    : '_Page/TransaksiJualBeli/TombolAutoJurnal.php',
    success     : function(data){
...
$('#ModalSettingAutoJurnal').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormSettingAutoJurnal.php',
        success     : function(data){
            ...
            $('#ProsesSettingAutoJurnal').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesSettingAutoJurnal.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalResetSettingAutoJurnal').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormResetSettingAutoJurnal.php',
        success     : function(data){
            ...
            $('#KonfirmasiResetAutoJurnal').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesResetAutoJurnal.php',
                    cache       : false,
                    processData : false,
                    contentType : false,
                    enctype     : 'multipart/form-data',
...
$('#ModalTambahPembayaran').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormTambahPembayaran.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
            ...
            $('#ProsesTambahPembayaran').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesTambahPembayaran.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
...
$('#ModalDetailPembayaran').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormDetailPembayaran.php',
...
$('#ModalHapusPembayaran').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormDeletePembayaran.php',
        data        : {id_pembayaran: id_pembayaran},
        success     : function(data){
            ...
            $('#KonfirmasiHapusPembayaran').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesHapusPembayaran.php',
                    data        : {id_pembayaran: id_pembayaran},
                    success     : function(data){
...
$('#ModalHapusSemuaPembayaran').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormHapusSemuaPembayaran.php',
        data        : {id_transaksi: id_transaksi},
        success     : function(data){
            ...
            $('#KonfirmasiHapusSemuaPembayaran').click(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesHapusSemuaPembayaran.php',
                    data        : {id_transaksi: id_transaksi},
                    success     : function(data){
...
$('#ModalEditPembayaran').on('show.bs.modal', function (e) {
    ...
    $.ajax({
        type 	    : 'POST',
        url 	    : '_Page/TransaksiJualBeli/FormEditPembayaran.php',
        data        : {id_pembayaran: id_pembayaran},
        success     : function(data){
            ...
            $('#ProsesEditPembayaran').submit(function(){
                ...
                $.ajax({
                    type 	    : 'POST',
                    url 	    : '_Page/TransaksiJualBeli/ProsesEditPembayaran.php',
                    data 	    :  data,
                    cache       : false,
                    processData : false,
                    contentType : false,
